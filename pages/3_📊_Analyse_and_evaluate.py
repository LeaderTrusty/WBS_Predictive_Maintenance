...
model = joblib.load(r'C:\Users\arbab\Documents\Repositories\WBS_Predictive_Maintenance\models\ML_balanced_multi.joblib')
...
#st.markdown("<h1 color: #A5D7E8;'>Enter</h1>", unsafe_allow_html=True)
